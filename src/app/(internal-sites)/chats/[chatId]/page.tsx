                ...
                {replyToMessageId && (
                  ...
                  >
                    ...
                    >
                      ...
                      <button
                        className="border-secondary-foreground bg-primary absolute top-1/2 right-4 flex h-8 w-8 -translate-y-1/2 transform cursor-pointer items-center justify-center rounded-xs border-2 p-1 lg:h-10 lg:w-10 lg:p-2"
                        onMouseDown={(e) => {
