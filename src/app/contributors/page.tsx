    ...
    <div className="border-secondary-foreground bg-card-foreground flex w-11/12 justify-between rounded-2xl border-2 p-5 sm:w-7/12 lg:block lg:w-6/12 2xl:w-4/12">
      <div className="flex items-center lg:justify-between">
        <div className="flex flex-wrap items-center justify-start">
          ...
          <div className="order-1 mt-0.5 ml-4 lg:flex lg:justify-between">
      ...
      <div
        className={cn(
          "text-secondary-foreground justify-around text-xl underline lg:mt-3 lg:flex",
          {
      ...
      >
        {props.contributor.website ? (
          ...
          >
            ...
            <LinkChain className="mt-1 ml-1 h-5 w-5" />
          </Link>
        ) : null}
        ...
        {props.contributor.linkedin ? (
          <Link className="flex" href={props.contributor.linkedin}>
            ...
            <LinkedInLogoIcon className="mt-2.5 ml-1 h-5 w-5 lg:mt-1" />
          </Link>
        ) : null}
        ...
        {props.contributor.github ? (
          ...
          >
            ...
            <SiGithub className="mt-2.5 ml-1 h-5 w-5 lg:mt-1" />
          </Link>
        ) : null}
      </div>
    </div>
  ...
  return (
    <main className="flex min-h-screen flex-col">
      <div className="flex flex-1 flex-col items-center justify-center">
        <div className="mt-6 mb-5 flex text-3xl lg:text-4xl">
          <div
            onClick={() => {
              router.back();
            }}
            className="absolute top-6 left-4 flex cursor-pointer items-center gap-1 text-xl font-bold"
          >
            <ArrowLeft />
