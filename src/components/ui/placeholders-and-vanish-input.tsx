...
>(({ placeholders, onChange, onSubmit, animationInput }, ref) => {
  ...
  return (
    <form
      className={cn(
        "relative mx-auto h-11 w-full max-w-xl overflow-hidden rounded-sm border-2 border-secondary-foreground bg-white shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),_0px_1px_0px_0px_rgba(25,28,33,0.02),_0px_0px_0px_1px_rgba(25,28,33,0.08)] transition duration-200 dark:bg-secondary lg:h-16",
        value && "bg-gray-50",
      )}
        ...
        <AnimatePresence mode="wait">
          {!value && (
            <motion.p
              ...
              className="w-full truncate pl-4 text-left text-sm font-normal text-neutral-500 dark:text-zinc-500 sm:text-base"
            >
